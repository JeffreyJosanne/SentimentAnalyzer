...
tweets = open("/home/jeffrey/python_playground/SentiAnalaze/Obama.txt").read()
tweets_list = tweets.split('\n')

pos_sent = open("/home/jeffrey/python_playground/SentiAnalyze/positive.txt").read()
positive_words=pos_sent.split('\n')
positive_counts=[]

neg_sent = open('/home/jeffrey/python_playground/SentiAnalyze/negative.txt').read()
